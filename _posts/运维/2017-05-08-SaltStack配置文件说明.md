---
title: SaltStack配置文件说明
date: 2017-05-08T13:11:52+00:00
author: 深海游鱼
layout: post
categories:
  - 运维
...
# seconds.
# Salt和API命令超时时间,单位：秒/s
#timeout: 5

# The loop_interval option controls the seconds for the master's maintenance
# process check cycle. This process updates file server backends, cleans the
# job cache and executes the scheduler.
# 设置SaltStack进程检测周期(job cache fileserver backends等等)
#loop_interval: 60
...
file_roots:
  ...
  dev:
    - /srv/salt/dev/services
    - /srv/salt/dev/statues
  prod:
    - /srv/salt/prod/services
    - /srv/salt/prod/status
